...
Consult the https://github.com/chicago-cdac/textbook-datascience-1/wiki[repository Wiki] for more information on authoring content.

In particular, be aware of the https://github.com/chicago-cdac/textbook-datascience-1/wiki/Guidelines[provided Guidelines] for:
